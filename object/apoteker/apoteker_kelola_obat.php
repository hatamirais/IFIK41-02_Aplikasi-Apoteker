  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <a class="btn btn-primary" href="apoteker_kelola_obat.php">Tambah Data</a>
		...
		<?php 
		include "koneksi.php";
		$query_mysqli = mysqli_query("SELECT * FROM obat")or die(mysqli_error());
		$nomor = 1;
		...
		<tr>
            ...
            <td><?php echo $data['tanggal masuk']; ?></td>
            <td><?php echo $data['tanggal kadaluarsa']; ?></td>
			<td>
